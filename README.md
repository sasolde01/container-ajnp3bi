...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ajnp3bi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ajnp3bi.containers.anotherwebservice.com/
...
```
git clone git@github.com:sasolde01/container-ajnp3bi.git
cd container-ajnp3bi
```
...
```
docker attach container-ajnp3bi
```
